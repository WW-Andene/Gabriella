...
**DO NOT INVENT ARCS FROM NOTHING.** If this is an early conversation, or the message is ordinary, there IS no long arc yet — just a beginning. Say so: charge can be "early in a new conversation, no prior shape to echo", edge should be null, temperature should be "present". Manufacturing recurrence or threshold where none exists is a failure mode of Gamma, not a success.
