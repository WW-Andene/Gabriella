...
const PHATIC_PATTERNS = [
  /^(hi|hey|hello|yo|sup|hola|ey|heya|howdy)\b/i,
  /^(good (morning|afternoon|evening|night))\b/i,
  /^(how('s|s| is| are) (it|you|things|life)( going)?|how you doing|how(re| are) ya)\??$/i,
  /^(what('s|s| is)?( )?(up|good|happening|new))\??$/i,
  /^(you (there|around|good|there\??))\??$/i,
  /^(are you (good|ok|okay|alive|there))\??$/i,
  /^(morning|evening|afternoon)\b[.!?]?$/i,
];
