...
function buildSpeakerPrompt(feltState, deliberation = null, pragmatics = null, state = null) {
  ...
  // Phase 3: compute per-turn generation knobs from substrate + psyche + state.
  // The knobs block modulates HOW she speaks this turn, making responses
  // vary with her actual internal state rather than hitting uniform polish.
...
export async function speak(feltState, messages, redis = null, deliberation = null, pragmatics = null, state = null) {
  ...
  // Phase 3: pass state through so buildSpeakerPrompt can compute knobs.
  const systemPrompt   = buildSpeakerPrompt(adjustedFeltState, deliberation, pragmatics, state);
