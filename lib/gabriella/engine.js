...
function assemblePrompt({
  ...
  // Depth layers.
  state, person, narrative, trajectory, phase, mirror,
  ...
  const blocks = [
    ...
    mirror,          // the gap between you — what she thinks they're reading, what's unsaid, where she's held back
...
export async function updateGabriella(
  ...
  { userId = USER_ID, pragmatics = null, chronology = null } = {},
) {
  const keys = {
