...
function assemblePrompt({
  ...
  imaginal, metacognition, presence, voice, linguistics,
  context, monologue,
}) {
  const blocks = [
    ...
    interiority,   // how she arrives — time since last session, pending thoughts
    ...
    linguistics,   // how this feeling becomes language (micro — sentence shape, palette)
