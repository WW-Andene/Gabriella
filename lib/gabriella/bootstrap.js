...
export async function generateScenarioDialogue(scenario) {
  ...
  // withKeyRotation auto-retries on 429 / 5xx across every configured
  // Groq key. When one key's rate limit saturates, the next call rolls
  // to the next key seamlessly. Invisible to the rest of the pipeline.
